                  ...
                  <nav className="flex gap-1" aria-label="Tabs">
                    {chains.map((chain, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center">{chain.svg}{chain.name}</div>
                        </a>
                      )
                    })}
                  </nav>
