				...
				{nftKey && tokenId && (
					<div className="flex items-center justify-between py-5">
						...
						<div className="ml-2 inline-block">
							<button
								className="bg-green-300 p-3 text-black"
								onClick={() => setIsShareDialogShow(true)}
							>
								<ShareIcon />
							</button>
						</div>
						...
						filteredData.map((audioState, key) => {
							if (audioState.data) {
								return (
									<div
										key={key}
										className="border-1 m-1 h-[90px] rounded-lg bg-[#181818] px-8 py-2 text-left"
									>
