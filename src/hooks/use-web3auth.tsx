...
export const Web3AuthProvider = ({ children }: Web3AuthProviderProps) => {
  ...
  async function initWeb3AuthModal(): Promise<void> {
    ...
    const web3auth = new Web3Auth({
      clientId: 'BNLEvTMM3yB6Sc0aVQ1OrmEJDCJbQLEaR330Lmt8r_RumrgNSiZ0cPxJCvuXdpFeKBwhPA202tbNyRFDN0fhgEA', // Get your Client ID from Web3Auth Dashboard
      chainConfig: {
  ...
  async function signMessage(message: string) {
    ...
    let web3 = new Web3(web3Auth?.provider as any);
